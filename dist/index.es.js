...
var BarChart = /** @class */ (function () {
    function BarChart(e, options) {
        this.init(e, options);
    }
    BarChart.prototype.init = function (e, options) {
        ...
        this.x = linear$2().range([0, this.width]);
        this.y = linear$2().range([this.height, 0]);
        this.chart = select(e)
            .append('svg')
    ...
    BarChart.prototype.render = function (data) {
        ...
        this.x.domain([0, max(data, function (d) { return d.value; })]);
        this.y.domain([0, max(data, function (d) { return d.value; })]);
        ...
        bar
            ...
            .attr('y', function (d) { return _this.y(d.value) + 3; })
            .attr('dy', '.75em')
...
var TreeChart = /** @class */ (function () {
    ...
    TreeChart.prototype.init = function (config) {
        console.warn(config);
        var svg = select('#tree-element').append('svg');
        var y = linear$2().domain([15, 90]).range([150, 0]);
        var x = log$1().domain([250, 100000]).range([0, 600]);
        var r = sqrt$1().domain([52070, 1380000000]).range([10, 50]);
        svg.append('circle').attr('fill', 'red').attr('r', r(1380000000));
    };
    return TreeChart;
}());

export { BarChart, LineChart, PieChart, TreeChart };
